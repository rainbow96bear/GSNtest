...
contract RubixEscrow is BasePaymaster {
    ...
    function addFunds(
        ...
        require(amount>= 100*10**18, "amount is less than 100");
    ...
    function _preRelayedCall(
        ...
        require(
            usedAmount[relayRequest.request.to] + (gasleft() * tx.gasprice) < GasLimit,
            "over the limit"
        );
    ...
    function withdrawToEscrowWallet(uint256 amount) public onlyOwner {
        relayHub.withdraw(payable(RBX_ESCROW_WALLET), amount);
    }
